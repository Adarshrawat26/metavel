        ...
        <div className="max-w-[1200px] mx-auto space-y-8">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              ...
              <p className="text-black/40 font-black uppercase tracking-widest text-[12px]">Evaluating SteelCraft Ltd • CON-829</p>
            </div>
            <button 
              onClick={() => setShowRenewalAI(true)}
              className="bg-[#FF7A45] text-white px-6 py-2 rounded text-[12px] font-black uppercase tracking-widest hover:bg-[#F26636] transition-all flex items-center gap-1.5"
            >
          ...
          <div className="border border-black/5 rounded p-10">
            ...
            <div className="space-y-12 relative before:absolute before:left-[17px] before:top-2 before:bottom-2 before:w-[1px] before:bg-black/5">
              {[
                ...
                { type: "Dispute", title: "Quality Incident", date: "Sep 22, 2025", desc: "Batch #829 returned due to seal failure. Resolved in 48h.", icon: AlertCircle },
                ...
                <div key={i} className="flex gap-8 relative">
                  <div className="w-9 h-9 rounded-full bg-white text-black flex items-center justify-center shrink-0 z-10 border border-black/5">
